...
import os
import alexnet3D_model as model
...
tf.app.flags.DEFINE_integer('training_epoch', 20, "training epoch")
...
# Data info.
image_size = 32     #image size (32*32*32)
image_channel = 1   #number of channels (1 for black & white)
label_cnt = 2       #number of classes
